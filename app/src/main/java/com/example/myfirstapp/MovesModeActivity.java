...
public class MovesModeActivity extends AppCompatActivity {
    ...
    private TextView mScoreField, mMovesField, mHighscoreField;
    private Button myButton;
    private RecyclerViewTouchListener mItemListener;
    private int mStartingMoves = 25, mMovesLeft, mHighscore, mScore = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        theme = MediaPlayer.create(MovesModeActivity.this,R.raw.bgm);
        ...
        setContentView(R.layout.activity_moves_mode);
        mMovesField = findViewById(R.id.time_display);
        ...
        mHighscore = mPref.getInt("moves_highscore", 0);
        mHighscoreField.setText("Highscore   : " + mHighscore);
        mMovesLeft = mStartingMoves;
        mMovesField = findViewById(R.id.moves_display);
        mMovesField.setText("Moves Remaining:   " + mMovesLeft);
        ...
        mItemListener = new RecyclerViewTouchListener(this, mRecyclerView ) {
            ...
            public void removeBlobs(List<View> selectList) {
                ...
                if (mMovesLeft <= 0) {
                    ...
                    if (mScore > mHighscore) {
                        ...
                        mPrefEditor.putInt("moves_highscore", mHighscore);
                        mPrefEditor.commit();
        ...
        myButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mRecyclerView.removeOnItemTouchListener(mItemListener);
                restartGameState(mItemListener);
                mGameOverScreen.setVisibility(View.GONE);
            }
        });
     ...
     * @param mItemListener
     */
    public void restartGameState(final RecyclerViewTouchListener mItemListener) {

        mIsGameOver = false;
        mMovesLeft = mStartingMoves;
        mScore = 0;
        mScoreField.setText("Score   " + mScore);
        mMovesField.setText("Moves Remaining:   " + mStartingMoves);
        mRecyclerView.addOnItemTouchListener(mItemListener);
    }
